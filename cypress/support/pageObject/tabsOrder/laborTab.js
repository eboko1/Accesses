class LaborTab {
    ...
    addLaborGroupProduct = () => {
        ...
        cy.get('.ant-modal-body').should('be.visible')
        cy.get('[data-qa="input_service_name_add_service_modal"]').clear()                                  // найменування
        cy.get('[data-qa="input_service_name_add_service_modal"]').type('заміна+test').should('have.value','заміна+test')  // найменування

        cy.get('[data-qa="input_number_purchase_price_add_service_modal"]').clear()  ////{backspace}                  // Закуп. ціна
        cy.get('[data-qa="input_number_purchase_price_add_service_modal"]').type('222').should('have.value','222')   // Закуп. ціна

        cy.get('[data-qa="input_number_count_add_service_modal"]').clear()                                 // Кіл-ть
        cy.get('[data-qa="input_number_count_add_service_modal"]').type('2').should('have.value','2')     // Кіл-ть
    ...
    addLaborName = () => {
        ...
        cy.get('[data-qa="input_number_purchase_price_add_service_modal"]').eq(0).clear().type('444.44').should('have.value','444.44')
        cy.get('.ant-modal-body').should('be.visible')
