class ProductTab {
    ...
    addProduct = () => {
        ...
        cy.get('[data-qa="input_number_purchasePrice_order_detail_edit_modal"]').clear().type('11.1').should('have.value','11.1')
        cy.get('[data-qa="input_number_price_order_detail_edit_modal"]').clear().type('1.2').should('not.be.NaN')
